...
path_user <- str_c("/Users/paul")
path_github <- str_c(path_user,"/Documents/Professionnel/Github")
path_data.source <-str_c(path_github,"/EmissionsIndicators/data_in/")

path_codedata <- str_c(path_github,"/EmissionsIndicators/")
