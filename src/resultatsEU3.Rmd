...
table_EU[table_EU=="Lettonnie",]$nom_pays = "Lettonie"
table_EU[table_EU$nom_pays=="Pays-bas",]$nom_pays = "Pays-Bas"
```
...
table_EU_ponderation=merge(table_EU,pib,by.x="nom_pays")
table_EU_ponderation=merge(table_EU_ponderation,pop,by.x="nom_pays")
...
for (pays in c("Autriche","Belgique","Bulgarie","Chypre","République Tchèque","Allemagne",
  ...
  IO <- table_EU_ponderation %>% filter(nom_pays==pays)
