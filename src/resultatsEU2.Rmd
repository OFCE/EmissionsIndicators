...
```{r monde secteurs, echo=FALSE, fig.cap="Des inégalités d'impacts qui varient selon l'approche choisie"}
monde_secteurs
```
...
DIAGONALISER POUR TROUVER LES VOLUMES DE LA BONNE DIMENSION

FAIRE LES RADARS AVEC LES MULTIPLICATEURS PLUTOT QUE VOLUMES